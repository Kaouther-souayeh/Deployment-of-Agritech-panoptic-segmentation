...
def main(config):
    ...
    subset =[1, 3, 4, 5, 6, 8, 9,11, 12, 13, 14, 16, 18, 19,20,21, 23, 25,28, 31, 33, 34, 36, 39]
    if config['preload']:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--res_dir', default='./Sensibilite/num_workers_results4', help='Path to the folder where the results should be stored')
