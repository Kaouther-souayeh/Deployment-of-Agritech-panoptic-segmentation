    ...
    for fold, (train_loader, val_loader, test_loader) in enumerate(loaders):
        ...
        # freeze backbone layers
                for param in model.children():
                  count +=1
                  if count < 3: #freezing first 2 layers
...
if __name__ == '__main__':
    ...
    parser.add_argument('--res_dir', default='./Tunisie_CODE_CULT/Data_aug3_results', help='Path to the folder where the results should be stored')
    ...
    parser.add_argument('--epochs', default=180, type=int, help='Number of epochs per fold')
